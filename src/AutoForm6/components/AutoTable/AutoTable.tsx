...
} from "../../utils/getColumnsDescription";
  ...
  return (
    <div className="frame1059-auto-form6-auto-table">
      <div className="frame1059-auto-form6-auto-table-header">
        ...
        >
          rows:
          <div className="frame1059-auto-form6-auto-table-header-value">
            {numberRows}
          </div>
          pages:
          <div className="frame1059-auto-form6-auto-table-header-value">
      ...
      {valuesPage.map((row, index) => (
        <AutoTableRow
          key={
            originalIndex ? originalIndex[startRow + index] : startRow + index
          }
          index={
            originalIndex ? originalIndex[startRow + index] : startRow + index
          }
  ...
  return (
    <div
      className={
        ...
        (showLabelInRow
          ? ""
          : " frame1059-auto-form6-auto-table-row-without-label")
      }
    ...
    >
      ...
      >
        {showLabelInRow && (
          <div className="frame1059-auto-form6-auto-table-cell-label">
            &nbsp;
          </div>
        )}
        <div className="frame1059-auto-form6-auto-table-cell-value-index">
          {index + 1}
        </div>
      </div>
      {columns.map((column) => (
...
export function AutoTableCellHeader({ column }: { column: ColumnDescription }) {
  if (column.type === "JSONNull") {
    return (
      <div className="frame1059-auto-form6-auto-table-cell-null">
        <div className="frame1059-auto-form6-auto-table-cell-label-boolean">
          {column.label}
        </div>
      </div>
    );
  ...
  if (column.type === "JSONString") {
    return (
      <div
        style={{
          width:
            column.maxLength * coefficientSymbolWidth +
            paddingInnerElements +
            "px",
        }}
        className="frame1059-auto-form6-auto-table-cell"
      >
  ...
  if (column.type === "JSONNumber") {
    return (
      ...
      >
        <div className="frame1059-auto-form6-auto-table-cell-label-number">
          {column.label}
        </div>
      </div>
    );
