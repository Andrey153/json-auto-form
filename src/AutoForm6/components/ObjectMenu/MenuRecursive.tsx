    ...
    <>
      {Object.entries(inValue as JSONObject).map(([key, val]) => {
        ...
        if (typeVal === "JSONObject") {
          return (
            <div
              className="frame1059-auto-form6-menu-with-submenu-container"
              key={key}
            >
              <div
...
export function MenuElementRecursive({
  ...
  const isActiveItem = !path.find(
    (element, index) => activePath[index] !== element
  );
  ...
  const isSubItemsPresent = Object.entries(inValue as JSONObject).find(
    ([key, val]) => {
      const typeVal = getJsonType(val);
    ...
    <div className="frame1059-auto-form6-menu-with-submenu-container">
      <div
        className={
          ...
          (isActiveItem
            ? " frame1059-auto-form6-menu-item-object-active"
            : "") +
          " " +
          getLevelClass(level)
        }
      ...
      {isSubItemsPresent && unfoldSubMenuCheck && (
        <div className="frame1059-auto-form6-menu-submenu">
          {Object.entries(inValue as JSONObject).map(([key, val]) => {
            ...
            if (typeVal === "JSONArray") {
              const isActiveArrayItem = activePath
                .toString()
                .startsWith([...path, key].toString());
              return (
                <div
                  className={
                    "frame1059-auto-form6-menu-item-array" +
                    (isActiveArrayItem
                      ? " frame1059-auto-form6-menu-item-array-active"
                      : "") +
                    " " +
                ...
                >
                  ...
                  <div className="frame1059-auto-form6-menu-item-array-icon">
                    ☰
                  </div>
                </div>
              );
